                    ...
                    <div class="card-body">
                      ...
                      <img src="{{ asset('/uploads/assets/images/'.$asset->image) }}" style="width:200px;" />
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('category') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('category', $asset->category, array('id' => 'category', 'class' => 'form-control', 'placeholder' => trans('forms.create_asset_ph_category'))) !!}
                                        <div class="input-group-append">
                                            <label for="category" class="input-group-text">
                                                <i class="fa fa-fw {{ trans('forms.create_asset_icon_category') }}" aria-hidden="true"></i>
                                            </label>
                                        </div>
                                    </div>
